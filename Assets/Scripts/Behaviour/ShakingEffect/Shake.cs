...
public class Shake : ScriptableObject
{
    ...
    [SerializeField,Slider(0.0f,0.5f)] float shakeFrequency = 1;
    [SerializeField] bool shakeX = true;
    [SerializeField] bool shakeY = true;
    [SerializeField] bool shakeZ = true;

    public Shake(AnimationCurve p_shakeOverLifetime,float p_lifeTime,float p_shakeMagnitude, float p_shakeFrequency,bool p_shakeX = true,bool p_shakeY = true,bool p_shakeZ = true)
    {
